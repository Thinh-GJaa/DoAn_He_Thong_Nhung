...
// const char *ssid = "Crema Coffee24h Lau2";     // Tên mạng WiFi của bạn
// const char *password = "88888888";             // Mật khẩu mạng WiFi của bạn
...
const int maxNumSample = 480;  // Số dữ liệu lấy tối đa
const int timedelay = 20; //20ms lấy data 1 lần
